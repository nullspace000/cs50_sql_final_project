...
INSERT INTO "tournaments_teams" ("tournament_id",
"team_id")
SELECT * FROM "temp";
DROP TABLE "temp";
...
-- match_events
CREATE TEMP TABLE "temp" ("match_id" INTEGER, "player_id" INTEGER, "team_id" INTEGER, "event_type" TEXT);
.mode csv
.import --skip 1 seeding/match_events_seed.csv temp
